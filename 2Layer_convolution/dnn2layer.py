...
def multilayer_perceptron(x, weights, biases):
    ...
    # layer 2
    layer_2 = tf.matmul(layer_1, clip_grad(weights['h2'],5.5))#+biases['b1']
    layer_2 = tf.nn.tanh(layer_2)

    # Output layer with linear activation
    out_layer = tf.matmul(layer_2, clip_grad(weights['out'], 5.5))#+biases['out']
